...
from erpclaw.config import OPENAI_API_KEY, TELEGRAM_BOT_TOKEN
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE) -> None:
    ...
    await update.message.reply_text("Ciao! Sono ERPClaw, il tuo gestionale aziendale. Come posso aiutarti?")
